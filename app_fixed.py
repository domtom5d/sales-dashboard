...
if data_source == "Upload CSV Files":
    ...
    # Apply filters
    if st.sidebar.button("Load Data", key="load_data_button", help="Click to load data with the selected filters"):
        with st.sidebar:
            st.success("Starting data load process...")
...
if st.session_state.processed_df is not None:
    ...
    st.info("""
    ### 👈 Please click the 'Load Data' button in the sidebar to get started
    
    This dashboard provides comprehensive analytics on your sales conversion data,
    including:
    
    - Conversion rates by various factors
...
# Main display section only shown when data is loaded
...
elif data_source == "Use Database Data":
